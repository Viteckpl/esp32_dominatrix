...
const unsigned long CALL_TIMEOUT_MS = 30000;    // 30 s to click after calling
const unsigned long PRESENCE_MIN_MS = 10000;    // 10 s
const unsigned long PRESENCE_MAX_MS = 600000;   // 10 min
const unsigned long SLEEP_HOLD_MS = 2000;       // 2 s hold
const unsigned long PUNISH_BLINK_MS = 400;      // LED blinking
